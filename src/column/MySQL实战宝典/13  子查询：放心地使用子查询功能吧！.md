...
![](assets/CioPOWC4r3iAWVV7AACB4gS2UBo664.png)
...
![](assets/Cgp9HWC4r4SAECp-AACB4gS2UBo705.png)
...
![](assets/Cgp9HWDB0u6Aews9AALrVP9U7VI559.png)
...
![](assets/CioPOWC4r7KACYe5AACVxJNJeuI046.png)

MySQL 8.0 版本执行过程

如果是老版本的 MySQL 数据库，它的执行计划将会是依赖子查询，执行计划如下所示：

![](assets/CioPOWC4r8iAfI8RAACR2EFttxI059.png)
...
![](assets/CioPOWC4r-OAFOmSAAFZr4rEsTs855.png)
...
![](assets/CioPOWC9iHGAGvHhAADKi9rGjL8095.png)
...
![](assets/CioPOWC4r_2AYA-8AACtbE83K7w426.png)

最后，来看下上述 SQL 的执行时间：

![](assets/CioPOWC4sAqAETsfAAA-Ui3vTHk812.png)
