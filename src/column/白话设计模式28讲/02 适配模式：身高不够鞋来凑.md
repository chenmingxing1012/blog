...
![image](assets/92000c10-71eb-11e8-89a0-a176c63a6bd8.jpg)
...
![image](assets/a0c29f50-71ec-11e8-9e76-835574e7e257.jpg)
...
![image](assets/dd5adc20-71ec-11e8-9e76-835574e7e257.jpg)

后来，随着业务的拓展，木板厂商增加了一种新木板 C。但 C 是 L 形的接口，不能与木板 A 对接。为了让木板 C 能与木板 A 进行对接，就需要增加一个衔接板 D 进行适配，而这个 D 就相当于适配器，如下图：

![image](assets/fadc6b10-71ec-11e8-b1ea-d92fd075c722.jpg)
...
![image](assets/43604d60-71ee-11e8-be4d-f5aac07d9486.jpg)
...
![image](assets/dcd4aa40-71ee-11e8-89a0-a176c63a6bd8.jpg)
...
![image](assets/19859f30-71ef-11e8-be4d-f5aac07d9486.jpg)

图2：第三方 PDF 解析库的类图

这时，我们就需要对 PDF 的解析库 MuPDF 进行适配。经过上面的学习，你一定知道这时该用适配器模式了，于是有了如下图3的类图结构。

![image](assets/306de130-71ef-11e8-b1ea-d92fd075c722.jpg)
...
class Reader:
    ...
    def gotoPage(self, pageNum):
        ...
        if(pageNum  self.__curBook.getPageCount()):
