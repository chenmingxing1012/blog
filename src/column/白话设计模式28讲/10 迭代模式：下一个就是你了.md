...
![image](assets/47b62430-de18-11e7-9fb6-af685862fa1c.jpg)
...
class Iterator:
    ...
    def next(self):
        ...
        if (self.__curIdx Lily您好！您已在挂号台成功挂号，序号：0001，请耐心等待！
...
![image](assets/40ccc600-de19-11e7-9fb6-af685862fa1c.jpg)
...
![image](assets/526922a0-de19-11e7-962e-6fc770f163b0.jpg)
...
![image](assets/796859c0-de19-11e7-962e-6fc770f163b0.jpg)

在实际的项目开发中有可能会有遇到一些更复杂的逻辑。如具有层级关系的组织架构：一个公司有 A、B、C 三个部门，每个部门有自己的部门成员，这时要遍历一个公司的所有成员。这里就会有类似这样的类图关系：

![image](assets/93f86e10-de19-11e7-9938-e7a5bced5c2d.jpg)
