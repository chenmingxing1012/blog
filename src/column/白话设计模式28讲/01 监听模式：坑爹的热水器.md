...
![image](assets/a01db720-d588-11e7-8257-812093f8cef1.jpg)
...
![image](assets/2bca8d20-d589-11e7-adba-9119e3f0586f.jpg)
...
class WashingMode(Observer):
    ...
    def update(self, observable, object):
        ...
        if isinstance(observable,
                      ...
                      WaterHeater) and observable.getTemperature() >= 50 and observable.getTemperature() = 100:
