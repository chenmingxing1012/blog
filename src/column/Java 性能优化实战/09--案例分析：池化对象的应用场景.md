...
![]\(assets/CgqCHl8xKV-AHSvoAAX4BkEi8aQ783.png)
 
我们再来介绍一下对象的生成过程，如下图，对象在进行**获取**时，将首先尝试从对象池里拿出一个，如果对象池中没有空闲的对象，就使用工厂类提供的方法，生成一个新的。
 
![]\(assets/Ciqc1F8xKWWAfETQAAXjITHnnyY877.png)
...
![]\(assets/CgqCHl8xKYKAdvm7AADGC-6LsfE257.png)
...
![]\(assets/CgqCHl8xKZGAbtiiAABfuEZ8gwQ793.png)
...
![]\(assets/Ciqc1F8xKaCAP0c2AADCCnpuRd0416.png)
...
![]\(assets/Ciqc1F8xKamACdt4AAG6dLqMUDo898.png)
...
![]\(assets/CgqCHl8xKb-AaPAfAABFiMwiWmM309.png)
...
![]\(assets/CgqCHl8xKcyAVb5-AAHduSa-zPY995.png)
