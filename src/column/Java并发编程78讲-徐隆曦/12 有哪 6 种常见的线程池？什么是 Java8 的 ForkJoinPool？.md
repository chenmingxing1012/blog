...
![]\(assets/CgotOV3kzoeARRniAAAwS8Pup4A734.png)
...
![]\(assets/CgoB5l3kzomAckv5AAAxf6FCPco696.png)
...
![]\(assets/CgotOV3kzomAflZxAAB99x9-MzI241.png)
...
![]\(assets/CgoB5l3kzoqAZgXiAACbX2rJCR4889.png)

在计算 f(4) 时需要首先计算出 f(2) 和 f(3)，而同理，计算 f(3) 时又需要计算 f(1) 和 f(2)，以此类推。

![]\(assets/CgotOV3kzoqAUlPyAADYOKK1PgM516.png)
...
![]\(assets/CgoB5l3kzouAdfLfAAARK97hw4g233.png)
...
![]\(assets/CgotOV3nFTCAKmNtAAES7A18i8M873.png)
...
![]\(assets/CgoB5l3nFSOAFOkbAABvJKvhTKk938.png)
