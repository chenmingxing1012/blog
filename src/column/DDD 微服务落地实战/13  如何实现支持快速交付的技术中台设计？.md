...
![](assets/Cip5yF_kdC6AKyj5AACxhqoIRjw348.png)

### 增删改的架构设计

![](assets/CgpVE1_kdD6AZg1HAALxpOUS2sc783.png)
...
![](assets/Ciqc1F_kdKOAU7-vAAUEADk6Fzw219.png)
...
The application context for query
...
```
 ...
 protected void beforeQuery(Map params) {
 ...
 protected ResultSet afterQuery(Map params, ResultSet resultSet) {
