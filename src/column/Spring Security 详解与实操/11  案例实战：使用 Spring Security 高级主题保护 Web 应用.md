...
![](assets/Cgp9HWDcHxyASKleAAC5AmJ3Hwc285.png)
...
![](assets/Cgp9HWDcHyuAT3auAACddvz56Cc067.png)
...
private void generateOrRenewAutoCode (User u) {
        ...
        Optional autoCode = autoCodeRepository.findAuthCodeByUsername(u.getUsername());
...
public boolean check(AuthCode authCodeToValidate) {
        ...
        Optional authCode = autoCodeRepository.findAuthCodeByUsername(authCodeToValidate.getUsername());
...
![](assets/CioPOWDcH0SAWPjtAAB7UfIfAyk803.png)
...
![](assets/CioPOWDcH1CAWsVIAACxvLoOLdE765.png)
...
![](assets/Cgp9HWDcH1mACUXeAADWBUPX0po513.png)
...
![](assets/Cgp9HWDcH2KAfoU3AAHK941R6Dk155.png)
