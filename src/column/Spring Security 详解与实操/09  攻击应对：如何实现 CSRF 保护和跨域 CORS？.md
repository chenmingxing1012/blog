...
![](assets/CioPOWDJ3xCAWERSAACPjO6QDvw503.png)
...
```
public interface JpaTokenRepository extends JpaRepository {

 

    Optional findTokenByIdentifier(String identifier);
...
public class DatabaseCsrfTokenRepository
    ...
    public void saveToken(CsrfToken csrfToken, HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse) {
        ...
        Optional existingToken = jpaTokenRepository.findTokenByIdentifier(identifier);
...
![](assets/Cgp9HWDJ3yyAFoiLAABaQZ0qSQE415.png)
...
![](assets/CioPOWDJ3zuAS8aXAADIA10IfrQ469.png)
