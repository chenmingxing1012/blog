...
![](assets/CioPOWC99xWAASrVAABnJyNceVM498.png)
...
```
final LinkedHashMap> createRequestMap() {
        ...
        for (UrlMapping mapping : getUrlMappings()) {
             ...
             Collection configAttrs = mapping.getConfigAttrs();
...
```
abstract List> getDecisionVoters(H http);
...
![](assets/Cgp9HWC99zqAGUOYAACtn7EjrO0914.png)
...
![](assets/CioPOWC990GAfLaXAACI8-bD1xs493.png)
