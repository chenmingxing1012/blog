...
![](assets/bd3d81d4-d928-4081-a2f7-96c11de76178.png)

**3. 内存报告**

然后等待，分析完成后，汇总信息如下：

![](assets/07acbdb7-0c09-40a5-b2c3-e7621a36870f.png)

分析报告显示，占用内存最大的问题根源 1：

![](assets/345818b9-9323-4025-b23a-8f279a99eb84.png)

占用内存最大的问题根源 2：

![](assets/07bbe993-5139-416a-9e6d-980131b649bf.png)

占用内存最大的问题根源 3：

![](assets/7308f1b5-35aa-43e0-bbb4-05cb2e3131be.png)
...
![](assets/b5ff6319-a5d9-426f-99ef-19bd100fd80a.png)

可以看到占用内存最多的是 2 个 ArrayList 对象。

鼠标左键点击第一个 ArrayList 对象，在弹出的菜单中选择 Show objects by class –> by outgoing references。

![](assets/6dbbb72d-ec2b-485f-bc8e-9de044b21b7d.png)

打开 class_references 标签页：

![](assets/28fe37ed-36df-482a-bc58-231c9552638d.png)
