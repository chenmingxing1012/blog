...
![](assets/58f59680-2d68-11ea-a743-8137f2e46c91.png)

也可以直接调用方法，例如查看 VM 参数：

![](assets/629d8300-2d68-11ea-a743-8137f2e46c91.png)

如果启动的进程是 Tomcat 或者是 Spring Boot 启动的嵌入式 Tomcat，那么我们还可以看到很多 Tomcat 的信息：

![](assets/6bd52180-2d68-11ea-b8bc-595e31068820.png)
...
```
![](assets/7c66ebf0-2d68-11ea-b6a8-fbb27a899f8c.png)

查看 User 的属性：

![](assets/84cfa1b0-2d68-11ea-8fee-9f496e85c50f.png)

直接修改 UserName 的值：

![](assets/8cb2acb0-2d68-11ea-b6fe-19eaa05aac2e.png)
