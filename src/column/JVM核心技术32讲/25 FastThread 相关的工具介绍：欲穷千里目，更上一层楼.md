...
#### **文件上传方式**
![](assets/98bd8e60-7504-11ea-92e8-fb0928480567.png)

选择文件并上传，然后鼠标点击“分析”（Analyze）按钮即可。


#### **上传文本方式**
![](assets/a5e18240-7504-11ea-94a5-05a63ed48ac3.png)
...
#### **CPU 消耗信息**
![](assets/cc8891d0-7505-11ea-b77f-634b57f46967.png)

这里的提示信息不太明显，但给出了一些学习资源，这些资源请参考本文末尾给出的博客链接地址。


#### **GC 线程信息**
![](assets/c466a910-7505-11ea-94a5-05a63ed48ac3.png)
