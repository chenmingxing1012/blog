...
![](assets/b255e7a0-5196-11ea-a2fb-85c45bbaa11c)
GraalVM 支持大量的语言，包括：
...
- 占用内存更低
启动时间对比：
![](assets/0e6b5c50-5197-11ea-b2e1-7d26d62747f1)
占用内存对比：
![](assets/16d152f0-5197-11ea-b2e1-7d26d62747f1)
### 解决了哪些痛点
...
从GitHub 下载页面中找到下载链接。
如下图所示：
![](assets/cf68b260-519a-11ea-bb37-55480bd50c9e)
...
```
其中-L选项，等价于--local-file或者--file，表示从本地文件安装组件。只要路径别填写错就行。
安装llvm-toolchain完成之后，查看安装路径，并配置到环境变量中：
```
