...
![]\(assets/Ciqah16HO4GAXM3XAACpvfOEmdk260.png)
...
![]\(assets/Ciqah16HO4KAbe-xAACSSN1rS98669.jpg)
...
![]\(assets/Cgq2xl6HO4KAYGALAAF3j6kY7OI652.png)
...
![]\(assets/Cgq2xl6HO4KAUCqzAAEDpeV55bE922.png)
...
![]\(assets/Cgq2xl6HO4KAbsMwAACVJa0xdMc029.jpg)
...
![]\(assets/Cgq2xl6HO4OAcpCUAAAYCOBxrH8618.png)
...
![]\(assets/Ciqah16HO4OAT38jAAAl0jcj3H0640.jpg)
...
栈帧包含：局部变量表、操作数栈、动态连接、返回地址等。![]\(assets/Cgq2xl6HO4OAInSTAACWN8lgBuA383.jpg)
...
![]\(assets/Ciqah16HO4OAX9fAAADieibiUuA348.png)
...
![]\(assets/Ciqah16HO4OAFZj9AAA7U919leM725.jpg)
...
![]\(assets/Cgq2xl6HO4OAYpeDAABCQlC0IWQ535.jpg)
...
![]\(assets/Ciqah16HO4OAO_N8AABmfN7QgL0284.jpg)

### safepoint 是什么？

当发生 GC 时，用户线程必须全部停下来，才可以进行垃圾回收，这个状态我们可以认为 JVM 是安全的（safe），整个堆的状态是稳定的。

![]\(assets/Cgq2xl6HO4SAVqTuAABceJSJQk8710.jpg)
...
![]\(assets/Ciqah16HO4SAYQTJAACt3FpxOSM490.png)
...
![]\(assets/Ciqah16HO4SADz5OAACHagS1bpQ945.jpg)

从各个层次分析代码优化的手段，如下图所示：

![]\(assets/Cgq2xl6HO4SAFAAeAADxCaBZvss793.png)
