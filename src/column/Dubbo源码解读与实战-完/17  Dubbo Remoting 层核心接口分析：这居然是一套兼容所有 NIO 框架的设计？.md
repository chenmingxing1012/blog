...
![](assets/CgqCHl9ptP2ADxEXAAuW94W_upc465.png)
...
![](assets/Ciqc1F9ptRqAJLQnAABcIxQfCkc811.png)
...
![](assets/CgqCHl9ptY2ADzl8AAEVDPN3HVo908.png)

我们先来看一下 dubbo-remoting-api 中对整个 Remoting 层的抽象，dubbo-remoting-api 模块的结构如下图所示：

![](assets/Ciqc1F9ptduASJsQAACrkCpgiGg477.png)
...
![](assets/CgqCHl9pteqACl0cAABxWeZ6ox0288.png)
...
![](assets/CgqCHl9ptf-AM7HwAABIy1ahqFw153.png)
...
![](assets/CgqCHl9ptgaAPRDbAAA7kgy1X5k082.png)
...
![](assets/Ciqc1F9pthSAPWv0AAA0yX1lW-Y033.png)
...
![](assets/CgqCHl9pthuAFNMOAABRJaJXls0493.png)

这些 Transporter 接口实现返回的 Client 和 RemotingServer 具体是什么呢？如下图所示，返回的是 NIO 库对应的 RemotingServer 实现和 Client 实现。

![](assets/Ciqc1F9ptiCAHkUSAADCSKg5KhY994.png)




![](assets/CgqCHl9pti-AHj3DAACwPfuEgm8435.png)
...
![](assets/CgqCHl9ptlyABsjpAAGGk7pFIzQ293.png)
